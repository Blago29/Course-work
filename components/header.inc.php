...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark custom-header fixed-top p-1 border-bottom" id="header">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="/Course-work/controllers/home.php">Риболовен свят</a>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-start">
          ...
          <li class="nav-item align-self-center">
            <a class="nav-link p-0" href="<?php if(isset($_SESSION["USER"])){echo '/Course-work/controllers/user_profile.php';} else{ echo '/Course-work/controllers/login.php';} ?>">
              <img src="/Course-work/images/profile/<?php if(isset($_SESSION["USER"][4])){echo $_SESSION["USER"][4];} else{ echo 'default.jpg';} ?>" alt="Profile" class="rounded-circle profile-image">
            </a>
          </li>
        </ul>
      </div>
